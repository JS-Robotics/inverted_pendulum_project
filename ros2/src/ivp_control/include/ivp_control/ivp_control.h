...
struct StateFeedbackGain{
  float k1 = -4.47213595;//-3.16227766; //-1.82574186; // -1.0;
  float k2 = -5.32032761;//-3.92589082; //-2.43262666; // -1.53667584;
  float k3 = 30.5649182;//23.98943665; //17.28282463; // 13.18171772;
  float k4 = 6.59008009;//5.25210054; //3.86484981; // 2.99319516;
};
